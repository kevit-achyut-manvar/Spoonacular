...
namespace SpoonacularAPI.Models
{
    ...
    public partial class RandomRecipeInformation
    {
        public static RandomRecipeInformation FromJson(string json) => JsonConvert.DeserializeObject<RandomRecipeInformation>(json, SpoonacularAPI.Models.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this RandomRecipeInformation self) => JsonConvert.SerializeObject(self, SpoonacularAPI.Models.Converter.Settings);
    }
